...
var canvasBorderOffset = 10;
var isObjectSelectable = designer ? true : false;
var custom_attribute = ['id', 'contentType', 'scaleMode', 'fontName', 'fontSrc', 'sizeType', 'text', 'locked', 'gradientAngle', 'isGradientInCenter', 'padding'];
...
var ButtonGeneratorComponent = /** @class */ (function () {
    function ButtonGeneratorComponent(fabricService, helperService) {
    ...
    ButtonGeneratorComponent.prototype.ngOnInit = function () {
        var _this = this;
        var that = this;
        ...
        this.canvas.on({
            'selection:created': function (e) {
                ...
                if (e.target.type == 'button') {
                    ...
                    _this.getAllTextProps();
                    _this.getAllButtonProps();
                }
            },
        ...
        this.fabricService._loadFont('roboto-regular', '').then(function (result) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var props, button;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                ...
                button = new fabric.Button("Click Me", props);
    ...
    ButtonGeneratorComponent.prototype.openButtonBackgroundTab = function (tabName) {
        this.activeButtonBackgroundTab = tabName;
    };
    ButtonGeneratorComponent.prototype.getAllTextProps = function () {
        var _this = this;
        var activeObject = this.canvas.getActiveObject().toObject();
        ...
        this._getFontFromFamily(this.props.fontFamily).then(function (result) {
            _this.props.font = result;
        });
    ...
    ButtonGeneratorComponent.prototype.getAllButtonProps = function () {
        var activeObject = this.canvas.getActiveObject().toObject();
        ...
        var finalButtonFill = activeObject.buttonFill || '#ffffff';
    ...
    ButtonGeneratorComponent.prototype.setActiveColor = function (data) {
        this.props.activeGradientColor = data.colorObject.color;
        this.props.activeGradientColorIndex = data.index;
    };
    // setProeprties
    ButtonGeneratorComponent.prototype.changeFontFamily = function (fontFamily) {
        var _this = this;
        this._getFontFromFamily(fontFamily).then(function (result) {
            _this.props.font = result;
            if (result != {}) {
                _this.fabricService._loadFont(_this.props.font.fontName, _this.props.font.fontSrc).then(function (result) {
                    _this.props.fontFamily = _this.props.font.fontName;
                    _this.selected.setButtonProp({ fontFamily: _this.props.fontFamily, fontName: _this.props.font.fontName, fontSrc: _this.props.font.fontSrc });
                }, function (err) {
                    console.log("font Can't load", err);
                }).catch(function (err) {
                    console.log("font Can't load", err);
    ...
    ButtonGeneratorComponent.prototype._getFontFromFamily = function (family) {
        var _this = this;
        return new Promise(function (resolve) {
            var font = {};
            _this.fontList.forEach(function (element) {
    ...
    ButtonGeneratorComponent.prototype.setButtonSize = function (prop) {
        this.selected.setButtonProp(prop);
        this.canvas.renderAll();
    };
    ButtonGeneratorComponent.prototype.setFontSize = function (fontSize) {
    ...
    ButtonGeneratorComponent.prototype.toggleStyle = function (style) {
        switch (style) {
            case 'bold':
    ...
    ButtonGeneratorComponent.prototype.toggleAlignment = function (align) {
        this.props.textAlign = align;
        this.selected.setButtonProp({ textAlign: align });
    };
    ButtonGeneratorComponent.prototype.setOpacity = function (opacity, isButtonProperty) {
        if (isButtonProperty === void 0) { isButtonProperty = false; }
        var property = isButtonProperty == true ? { opacity: opacity } : { textOpacity: opacity };
        this.selected.setButtonProp(property);
    };
    ButtonGeneratorComponent.prototype.setSpacing = function (charSpacing) {
        this.selected.setButtonProp({ charSpacing: charSpacing });
    };
    ButtonGeneratorComponent.prototype.setLineHeight = function (lineHeight) {
        this.selected.setButtonProp({ lineHeight: lineHeight });
    };
    ButtonGeneratorComponent.prototype.setFill = function (fill) {
        this.selected.setButtonProp({ color: fill });
    };
    ButtonGeneratorComponent.prototype.setBackground = function (backgroundColor) {
        this.selected.setButtonProp({ backgroundColor: backgroundColor });
    };
    ButtonGeneratorComponent.prototype.setButtonStrokeColor = function (color) {
        this.props.buttonStrokeColor = color;
        this.selected.setButtonProp({ buttonStrokeColor: color });
    };
    ButtonGeneratorComponent.prototype.setButtonStrokeSize = function (size) {
        this.selected.setButtonProp({ buttonStrokeWidth: size });
    };
    ButtonGeneratorComponent.prototype.setButtonFill = function (color) {
        this.props.buttonFill = color;
        this.selected.setButtonProp({ buttonFill: color });
    };
    ButtonGeneratorComponent.prototype.setButtonGradient = function (colorArray) {
    ...
    ButtonGeneratorComponent.prototype._setGradientToButton = function (colorStop) {
        var invertangle = (this.props.buttonGradientAngle + 180) > 360 ? (this.props.buttonGradientAngle + 180) - 360 : (this.props.buttonGradientAngle + 180);
        var angle = this.props.buttonGradientAngle;
        var x1, y1, x2, y2;
        var button = { top: this.selected.top, left: this.selected.left, width: this.selected.width, height: this.selected.height };
        var p1 = this.helperService.edgeOfView(button, invertangle);
        var p2 = this.helperService.edgeOfView(button, angle);
        x1 = p1.x;
        y1 = p1.y;
        x2 = p2.x;
        y2 = p2.y;
    ...
    ButtonGeneratorComponent.prototype.changeGradientIndexColor = function (index, color) {
        ...
        var obj = tslib__WEBPACK_IMPORTED_MODULE_0__["__spread"](this.props.buttonGradientArray);
    ...
    ButtonGeneratorComponent.prototype.setButtonRadius = function (radius) {
        this.selected.setButtonProp({ buttonRx: radius, buttonRy: radius });
    };
    ButtonGeneratorComponent.prototype.setShadow = function (shadow) {
        this.selected.setButtonProp({ buttonShadow: shadow });
    };
    ButtonGeneratorComponent.prototype.setBTextShadow = function (shadow) {
        this.selected.setButtonProp({ textShadow: shadow });
    };
    // Download
    ButtonGeneratorComponent.prototype.downloadImage = function () {
        if (this.selected) {
            var width = this.selected.width * this.selected.scaleX, height = this.selected.height * this.selected.scaleY, top_1 = 0, left = 0, that_1 = this, offset = 10;
            if (that_1.selected.buttonShadow) {
                width += Math.abs(that_1.selected.buttonShadow.offsetX) + (that_1.selected.buttonShadow.blur);
                height += Math.abs(that_1.selected.buttonShadow.offsetY) + (that_1.selected.buttonShadow.blur);
                if (Math.sign(that_1.selected.buttonShadow.offsetY) == -1) {
                    top_1 = that_1.selected.buttonShadow.offsetY - that_1.selected.buttonShadow.blur;
                }
                else if (that_1.selected.buttonShadow.offsetY < that_1.selected.buttonShadow.blur / 2) {
                    top_1 = -that_1.selected.buttonShadow.blur;
                    height += that_1.selected.buttonShadow.blur;
                }
                if (Math.sign(that_1.selected.buttonShadow.offsetX) == -1) {
                    left = that_1.selected.buttonShadow.offsetX - that_1.selected.buttonShadow.blur;
                }
                else if (that_1.selected.buttonShadow.offsetX < that_1.selected.buttonShadow.blur / 2) {
                    left = -that_1.selected.buttonShadow.blur;
                    width += that_1.selected.buttonShadow.blur;
                }
            }
            this.selected.cloneAsImage(function (obj) {
                that_1.helperService._download("Button.png", obj.toDataURL());
            }, {
                format: 'png',
                top: top_1 - this.selected.buttonStrokeWidth - offset,
    ...
    ButtonGeneratorComponent.prototype.downloadJson = function () {
    ...
    ButtonGeneratorComponent.ctorParameters = function () { return [
    ...
    return ButtonGeneratorComponent;
}());
...
var ChooseSizeComponent = /** @class */ (function () {
    function ChooseSizeComponent(router) {
        this.router = router;
    ...
    ChooseSizeComponent.prototype.ngOnInit = function () {
    };
    ChooseSizeComponent.prototype.chooseSize = function (index) {
        this.sizeList[index].selected = !this.sizeList[index].selected;
        this.VarifySizeSelected();
    };
    ChooseSizeComponent.prototype.addSize = function (customWidth, customHeight) {
    ...
    ChooseSizeComponent.prototype.moveToGenerator = function () {
        var _this = this;
        this.VarifySizeSelected().then(function (result) {
            localStorage.setItem('sizelist', JSON.stringify(result));
            _this.router.navigate(['generator']);
        });
    };
    ChooseSizeComponent.prototype.VarifySizeSelected = function () {
        var _this = this;
        return new Promise(function (resolve) {
            var filteredArray = _this.sizeList.filter(function (item) {
                return item.selected == true;
            });
            filteredArray.length <= 0 ? _this.isSelected = false : _this.isSelected = true;
            filteredArray.length == _this.sizeList.length ? _this.isAllSelected = true : _this.isAllSelected = false;
            resolve(filteredArray);
        });
    };
    ChooseSizeComponent.prototype.toggleAllSelection = function () {
        if (this.isAllSelected) {
            this.sizeList.forEach(function (element) {
    ...
    ChooseSizeComponent.ctorParameters = function () { return [
...
var FabricService = /** @class */ (function () {
    ...
    FabricService.prototype.generateRandomNumber = function () {
        return Math.round(Math.random() * 1000000);
    };
    FabricService.prototype.getAllLayer = function (canvasArr) {
        var _this = this;
        return new Promise(function (resolve) {
            var canvasWithMaxObjects = 0, maxObjectCanvasId;
            canvasArr.forEach(function (element, index) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
    ...
    FabricService.prototype.getObjectByAttr = function (canvas, attr, value) {
        return new Promise(function (resolve) {
            resolve(canvas.getItemByName(attr, value));
        });
    };
    FabricService.prototype.isCanvasPortrait = function (canvas) {
        var canvasHeight = canvas.getHeight(), canvasWidth = canvas.getWidth();
        return canvasHeight > canvasWidth + (canvasHeight / 6);
    };
    FabricService.prototype.isCanvasLandscape = function (canvas) {
        var canvasHeight = canvas.getHeight(), canvasWidth = canvas.getWidth();
        return canvasWidth > canvasHeight + (canvasWidth / 6);
    };
    FabricService.prototype.isCanvasSquare = function (canvas) {
        var canvasHeight = canvas.getHeight(), canvasWidth = canvas.getWidth();
        return (canvasWidth <= canvasHeight + (canvasWidth / 6)) && (canvasHeight <= canvasWidth + (canvasHeight / 6));
    };
    // Add Elements Functions
    FabricService.prototype.addDefaultButton = function (canvas, props) {
        var _this = this;
        return new Promise(function (resolve) {
            if (props.type == 'textButton') {
                _this._loadFont(props.fontName, props.fontSrc).then(function (result) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        props.fontName = result.fontName;
                        props.fontSrc = result.fontSrc;
                        this._addButton(canvas, props).then(function (result) {
                            resolve(canvas);
                        });
                        return [2 /*return*/];
                    });
                ...
                _this._addIconButton(canvas, props).then(function (result) {
                    resolve(canvas);
                });
            }
        });
    };
    FabricService.prototype._addButton = function (element, props) {
        var _this = this;
        return new Promise(function (resolve) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var positionOffset, excludedProperty, obj, key, button;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                positionOffset = _app_constants__WEBPACK_IMPORTED_MODULE_3__["canvasBorderOffset"] - 5;
                excludedProperty = ['type', 'previewImage'];
                obj = {
                    top: positionOffset,
                    left: positionOffset,
                ...
                button = new fabric.Button(props.text, obj);
                element.add(button);
                element.renderAll();
                resolve();
                return [2 /*return*/];
    ...
    FabricService.prototype._addIconButton = function (element, props) {
        var _this = this;
        return new Promise(function (resolve) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var positionOffset, excludedProperty, obj, key, button;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                positionOffset = _app_constants__WEBPACK_IMPORTED_MODULE_3__["canvasBorderOffset"] - 5;
                excludedProperty = ['src', 'type', 'previewImage'];
                obj = {
                    top: positionOffset,
                    left: positionOffset,
                    fontName: props.fontName,
                ...
                button = new fabric.IconButton(props.src, obj);
                element.add(button);
                element.renderAll();
                resolve();
                return [2 /*return*/];
    ...
    FabricService.prototype.addDefaultText = function (canvas, props) {
        var _this = this;
        return new Promise(function (resolve) {
            ...
            _this._loadFont(props.fontName, props.fontSrc).then(function (result) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    this._addText(canvas, props).then(function (result) {
                        resolve(canvas);
                    });
                    return [2 /*return*/];
                });
    ...
    FabricService.prototype._addText = function (element, props) {
        var _this = this;
        return new Promise(function (resolve) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var positionOffset, canvasWidth, canvasHeight, excludedProperty, obj, key, text;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                positionOffset = _app_constants__WEBPACK_IMPORTED_MODULE_3__["canvasBorderOffset"] - 5;
                canvasWidth = element.width - positionOffset;
                canvasHeight = element.height - positionOffset;
                excludedProperty = ['text'];
                obj = {
                    top: positionOffset,
                    left: positionOffset,
                    objectCaching: false
                ...
                text = new fabric.Textbox(props.text, obj);
    ...
    FabricService.prototype._loadFont = function (fontFamily, fontPath) {
    ...
    FabricService.prototype.addDefaultImage = function (canvas, props) {
        var _this = this;
        return new Promise(function (resolve) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                this._loadImage(canvas, props).then(function (result) {
                    resolve(canvas);
                });
                return [2 /*return*/];
            });
    ...
    FabricService.prototype._loadImage = function (element, props) {
        return new Promise(function (resolve) {
    ...
    FabricService.prototype.getScaleRatio = function (canvasWidth, canvasHeight, imageWidth, imageHeight, scaleMode) {
        return new Promise(function (resolve) {
            if (scaleMode) {
    ...
    FabricService.prototype.generateIdList = function (bannerset) {
        var _this = this;
        return new Promise(function (resolve) {
            var objectLayers = [];
            bannerset.forEach(function (json) {
                if (json.hasOwnProperty('sample_image')) {
                    for (var key in json) {
                        if (json.hasOwnProperty(key)) {
                            switch (key) {
                                case 'text_json':
                                    json[key].forEach(function (object) {
                                        var tmp = objectLayers.filter(function (layer) {
    ...
    FabricService.prototype.generateCanvas = function (canvas) {
        return new Promise(function (resolve) {
    ...
    FabricService.prototype.renderBackground = function (canvas, backgroundJSON) {
        var _this = this;
        return new Promise(function (resolve) {
            var that = _this;
            if (backgroundJSON.background_image) {
                fabric.Image.fromURL(backgroundJSON.background_image, function (img) {
                    that.getScaleRatio(canvas.width, canvas.height, img.width, img.height, backgroundJSON.scaleMode || 'scaleCrop').then(function (result) {
    ...
    FabricService.prototype.renderStickers = function (canvas, stickerJSON, idList) {
        var _this = this;
        return new Promise(function (resolve) {
            var Promises = [];
            stickerJSON.forEach(function (object) {
                var newId;
                var layer = idList.filter(function (layer) {
                ...
                if (layer.length > 0) {
                    ...
                    var promis = _this._loadImage(canvas, props);
                    promis.then(function (imgObject) {
                        imgObject.set({
                            top: object.yPos,
                            left: object.xPos,
                            width: object.width,
                            ...
                            angle: object.angle,
                            objectCaching: false,
                            selectable: _this.isCanvasLoacked,
                        });
                        canvas.renderAll();
                    });
    ...
    FabricService.prototype.renderText = function (canvas, textJSON, idList) {
        var _this = this;
        return new Promise(function (resolve) {
            textJSON.forEach(function (object) {
                var newId;
                var layer = idList.filter(function (layer) {
                ...
                if (layer.length > 0) {
                    newId = layer[0].id;
                    _this._loadFont(object.fontName, object.fontPath).then(function (font) {
    ...
    FabricService.prototype.renderButton = function (canvas, buttonJSON, idList) {
        var _this = this;
        return new Promise(function (resolve) {
            buttonJSON.forEach(function (object) {
                var newId;
                var layer = idList.filter(function (layer) {
    ...
    // Not In use
    FabricService.prototype.scaleCanvas = function (canvas, context, width, height) {
    ...
    FabricService.prototype.setPropertyToObject = function (canvas, objectId, property, isButtonProperty) {
        if (isButtonProperty === void 0) { isButtonProperty = false; }
        return new Promise(function (resolve, reject) {
...
var GeneratorExperimentComponent = /** @class */ (function () {
    // imageView: any = false;
    // buttonView: any = false;
    // bgColorView: any = false;
    // bgImageView: any = false;
    // bgScaleModeView: any = false;
    function GeneratorExperimentComponent(fabricService, helperService, router) {
        var _this = this;
        this.fabricService = fabricService;
        this.helperService = helperService;
        this.router = router;
        ...
        if (list) {
            var bannerSetArray = [];
            _app_constants__WEBPACK_IMPORTED_MODULE_4__["defaultBannerSet"].forEach(function (json, index) {
                bannerSetArray.push(json.sizeType);
            });
            this.sizes = JSON.parse(list);
            this.sizes.forEach(function (element) {
                if (bannerSetArray.indexOf(element.sizeType) != -1) {
                    ...
                    elem['locked'] = true;
                    _this.bannerSet.push(elem);
                }
                else {
                    element['locked'] = true;
                    _this.bannerSet.push(element);
                }
            });
        }
        else {
        ...
        this.processKeys = function (e) {
            ...
            this.checkForInputFocus().then(function (isInputFocus) {
                if (_this.selected) {
                    if ((e.keyCode === 8 || e.keyCode === 46) && isInputFocus != true && !(_this.selected.type == 'textbox' && _this.selected.isEditing)) {
                        // delete || backspace;
                        e.preventDefault();
                    ...
                    else if (e.keyCode === 38 && isInputFocus != true && !(_this.selected.type == 'textbox' && _this.selected.isEditing)) {
                        // Up Arrow
                        e.preventDefault();
                        _this.selected.top -= movementDelta;
                        _this.selected.setCoords();
                        _this.canvas[_this.unlockedCanvasIndex].renderAll();
                    }
                    else if (e.keyCode === 40 && isInputFocus != true && !(_this.selected.type == 'textbox' && _this.selected.isEditing)) {
                        // down arrow
                        e.preventDefault();
                        _this.selected.top += movementDelta;
                        _this.selected.setCoords();
                    ...
                    else if (e.keyCode === 37 && isInputFocus != true && !(_this.selected.type == 'textbox' && _this.selected.isEditing)) {
                        // Left arrow
                        e.preventDefault();
                        _this.selected.left -= movementDelta;
                        _this.selected.setCoords();
                        _this.canvas[_this.unlockedCanvasIndex].renderAll();
                    }
                    else if (e.keyCode === 39 && isInputFocus != true && !(_this.selected.type == 'textbox' && _this.selected.isEditing)) {
                        // Right Arrow
                        e.preventDefault();
                        _this.selected.left += movementDelta;
                        _this.selected.setCoords();
    ...
    GeneratorExperimentComponent.prototype.ngAfterViewInit = function () {
        var _this = this;
        // this.createCanvas().then(canvasResult => {
        //   this.renderStackObjects()
        // });
        this.fabricService.generateIdList(this.bannerSet).then(function (idList) {
            _this.bannerSet.forEach(function (element, index) {
                if (_app_constants__WEBPACK_IMPORTED_MODULE_4__["designer"] == true) {
                    _this.fabricService.generateCanvas({ width: element.width, height: element.height, sizeType: element.sizeType, index: index }).then(function (newCanvas) {
                        _this.addCanvasListener(newCanvas);
                        _this.canvas.push(newCanvas);
                        _this.hideLoader();
                    });
                }
                else {
                    if (element.hasOwnProperty('sample_image')) {
                        _this.fabricService.generateCanvas({ width: element.width, height: element.height, sizeType: element.sizeType, index: index }).then(function (newCanvas) {
                            _this.addCanvasListener(newCanvas);
                            _this.canvas.push(newCanvas);
                            _this.fabricService.renderBackground(newCanvas, element.background_json).then(function (result) {
                                _this.getBackgroundType().then(function (result) {
                                    _this.fabricService.renderStickers(newCanvas, element.sticker_json, idList).then(function (result) {
                                        _this.fabricService.renderText(newCanvas, element.text_json, idList).then(function (result) {
                                            _this.fabricService.renderButton(newCanvas, element.button_json, idList).then(function (result) {
                                                _this.renderStackObjects();
                                                _this.hideLoader();
                                            });
                                        });
                                    });
    ...
    // Utility Functions
    GeneratorExperimentComponent.prototype.checkForInputFocus = function () {
        return new Promise(function (resolve) {
    ...
    GeneratorExperimentComponent.prototype.toggleBar = function (type) {
        switch (type) {
            case 'left':
    ...
    GeneratorExperimentComponent.prototype.activeLeftTab = function (tabName) {
        this.activeTab = tabName;
        if (!this.isLeftShown) {
            this.toggleBar('left');
        }
    };
    GeneratorExperimentComponent.prototype.openBackgroundTab = function (tabName) {
        this.activeBackgroundTab = tabName;
    };
    GeneratorExperimentComponent.prototype.openButtonTab = function (tabName) {
        this.activeButtonTab = tabName;
    };
    GeneratorExperimentComponent.prototype.openButtonBackgroundTab = function (tabName) {
        this.activeButtonBackgroundTab = tabName;
    };
    GeneratorExperimentComponent.prototype.enterReplaceMode = function () {
        this.isReplaceMode = true;
        this.propertyPanel = false;
        this.activeLeftTab('tab_2');
    };
    GeneratorExperimentComponent.prototype.exitFromReplaceMode = function () {
        this.isReplaceMode = false;
        this.imageEditor = true;
        this.propertyPanel = true;
    };
    GeneratorExperimentComponent.prototype.showError = function (message, timeout, isActionButton) {
        var _this = this;
        if (timeout === void 0) { timeout = 3000; }
        if (isActionButton === void 0) { isActionButton = false; }
        this.isErrorShow = false;
        this.error = message;
    ...
    GeneratorExperimentComponent.prototype.hideError = function () {
        var _this = this;
        if (this.errorTimeOut)
            clearTimeout(this.errorTimeOut);
        this.isErrorShow = false;
    ...
    GeneratorExperimentComponent.prototype.dismissLoader = function () {
        this.loader = false;
        this.backdropClick = false;
    };
    GeneratorExperimentComponent.prototype.showLoader = function (backdropClick) {
        if (backdropClick === void 0) { backdropClick = false; }
        this.loader = true;
        this.backdropClick = backdropClick;
    };
    GeneratorExperimentComponent.prototype.hideLoader = function (backdropClick) {
        if (backdropClick === void 0) { backdropClick = false; }
        this.loader = false;
        this.backdropClick = backdropClick;
    };
    GeneratorExperimentComponent.prototype.copyValue = function (value) {
    ...
    GeneratorExperimentComponent.prototype.unlockSingleCanvas = function (clickedIndex) {
        var _this = this;
        this.canvas.forEach(function (element, index) {
            if (element.locked == false && clickedIndex != index) {
                _this.bannerSet[index].locked = true;
                element.set({
                    locked: true
                });
                element.forEachObject(function (object) {
                    object.set({
                        selectable: false
                    });
                });
        ...
        this.canvas[clickedIndex].forEachObject(function (object) {
            object.set({
                selectable: true
            });
        });
    ...
    GeneratorExperimentComponent.prototype.exitSingleMode = function (clickedIndex) {
    ...
    GeneratorExperimentComponent.prototype.addCanvasListener = function (canvas) {
        var _this = this;
        canvas.on({
            "selection:created": function (e) {
                _this.selected = e.target;
                _this.getPropertyPanelValue({ contentType: _this.selected.contentType, id: _this.selected.id });
            },
            ...
            'selection:cleared': function (e) {
                _this.selected = null;
                _this.deselectObject();
            }
        });
    };
    GeneratorExperimentComponent.prototype.renderStackObjects = function () {
        var _this = this;
        this.fabricService.getAllLayer(this.canvas).then(function (result) {
            _this.maxObjectCanvasId = result;
            var objects = _this.canvas[_this.maxObjectCanvasId].toJSON().objects;
            _this.layers = [];
            objects.forEach(function (element) {
                switch (element.type) {
                    case 'textbox':
                        _this.layers.push({ type: 'Text', contentType: element.contentType, text: element.text, id: element.id });
                        break;
                    case 'image':
                        _this.layers.push({ type: 'Image', src: element.src, contentType: element.contentType, id: element.id });
                        break;
                    case 'button':
                        _this.layers.push({ type: 'Button', contentType: element.contentType, text: element.text, id: element.id });
                        break;
                    case 'iconButton':
                        _this.layers.push({ type: 'IconButton', contentType: element.contentType, src: element.iconSrc, id: element.id });
                        break;
                }
            });
        });
    };
    GeneratorExperimentComponent.prototype.selectLayer = function (layer) {
        if (layer === void 0) { layer = {}; }
        this.activatedLayer = layer;
        this.getPropertyPanelValue(layer);
    };
    GeneratorExperimentComponent.prototype.getPropertyPanelValue = function (layer) {
        this.resetAllEditor();
    ...
    GeneratorExperimentComponent.prototype.getFinalValue = function (arr) {
        var counts = {};
        var compare = 0;
        var mostFrequent;
    ...
    GeneratorExperimentComponent.prototype.deselectObject = function () {
        this.activatedLayer = {};
        this.resetAllEditor();
        this.getCanvasFill();
    };
    GeneratorExperimentComponent.prototype.deleteLayer = function (layer) {
        ...
        if (this.isSingleMode == true) {
            ...
            var object = canvas.getActiveObject() || this.canvas[this.unlockedCanvasIndex].getItemByName('id', layer.id);
            canvas.remove(object).renderAll();
        }
        else {
            this.canvas.forEach(function (element) {
                element.remove(element.getItemByName('id', layer.id)).renderAll();
            });
        }
        this.renderStackObjects();
    };
    GeneratorExperimentComponent.prototype.removeSelected = function () {
        var canvas = this.canvas[this.unlockedCanvasIndex];
    ...
    GeneratorExperimentComponent.prototype.cleanSelect = function () {
        var canvas = this.canvas[this.unlockedCanvasIndex];
        var activeObject = canvas.getActiveObject();
    ...
    GeneratorExperimentComponent.prototype.closePropertyPanel = function () {
        this.propertyPanel = false;
        this.deselectObject();
    };
    GeneratorExperimentComponent.prototype.resetAllEditor = function () {
        this.propertyPanel = false;
        this.textEditor = false;
        this.buttonEditor = false;
        this.iconButtonEditor = false;
    ...
    GeneratorExperimentComponent.prototype.getLayer = function (id) {
        var _this = this;
        return new Promise(function (resolve) {
            var layer = null;
            for (var i = 0, length_1 = _this.layers.length; i < length_1; i++) {
                if (_this.layers[i].id == id) {
    ...
    GeneratorExperimentComponent.prototype.getAllTextProperties = function (id, isButton) {
        if (isButton === void 0) { isButton = false; }
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var defaultShadow, object, newFontStyle_1, newFontWeight, textOpacity, backgroundColor, fontSize, fontStyle, fontFamily, fill, lineHeight, opacity, shadow, text, textAlign, charSpacing, fontWeight, underline, overline, strikeThrough, i, element, object, newFontStyle, newFontWeight;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                defaultShadow = { color: '#000000', blur: 0, offsetX: 0, offsetY: 0, opacity: 0 };
                if (this.isSingleMode == true) {
                    object = this.canvas[this.unlockedCanvasIndex].getActiveObject().toJSON();
                    newFontStyle_1 = object.fontStyle;
                    newFontStyle_1 == 'italic' ? this.props.isItalic = true : this.props.isItalic = false;
                    newFontWeight = object.fontWeight;
                    newFontWeight == 'bold' ? this.props.isBold = true : this.props.isBold = false;
                    ...
                    textOpacity = [], backgroundColor = [], fontSize = [], fontStyle = [], fontFamily = [], fill = [], lineHeight = [], opacity = [], shadow = [], text = [], textAlign = [], charSpacing = [], fontWeight = [], underline = [], overline = [], strikeThrough = [];
                    for (i = 0; i < this.canvas.length; i++) {
                        element = this.canvas[i], object = element.getItemByName('id', id);
                        if (object) {
                    ...
                    newFontStyle = this.getFinalValue(fontStyle);
                    newFontStyle == 'italic' ? this.props.isItalic = true : this.props.isItalic = false;
                    newFontWeight = this.getFinalValue(fontWeight);
                    newFontWeight == 'bold' ? this.props.isBold = true : this.props.isBold = false;
    ...
    GeneratorExperimentComponent.prototype.getAllImageProperties = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var canvas, object, opacity, i, element, object;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (this.isSingleMode == true) {
                    canvas = this.canvas[this.unlockedCanvasIndex], object = canvas.getActiveObject().toJSON();
                    this.props.opacity = object.opacity;
                }
                else {
                    opacity = [];
                    for (i = 0; i < this.canvas.length; i++) {
                        element = this.canvas[i];
                        object = element.getItemByName('id', id);
                        if (object) {
                            opacity.push(object.opacity);
                        }
                    }
    ...
    GeneratorExperimentComponent.prototype.getAllButtonProperties = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var finalButtonFill, canvas, object, borderColor, borderSize, buttonFill, borderRadius, i, element, object;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (this.isSingleMode == true) {
                    canvas = this.canvas[this.unlockedCanvasIndex], object = canvas.getActiveObject().toJSON();
                    ...
                    borderColor = [], borderSize = [], buttonFill = [], borderRadius = [];
                    for (i = 0; i < this.canvas.length; i++) {
                        element = this.canvas[i], object = element.getItemByName('id', id);
                        if (object) {
    ...
    GeneratorExperimentComponent.prototype.getAllButtonTextProperties = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var defaultShadow, canvas, object, textShadow, i, element, object;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                defaultShadow = { color: '#000000', blur: 0, offsetX: 0, offsetY: 0, opacity: 0 };
                if (this.isSingleMode == true) {
                    canvas = this.canvas[this.unlockedCanvasIndex], object = canvas.getActiveObject().toJSON();
    ...
    GeneratorExperimentComponent.prototype.getAllButtonIconProperties = function (id) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var element, object, iconSize, iconColors, i, element, object;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (this.isSingleMode == true) {
                    element = this.canvas[this.unlockedCanvasIndex], object = element.getActiveObject().toJSON();
    ...
    GeneratorExperimentComponent.prototype.getBackgroundType = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, new Promise(function (resolve) {
                        if (_this.isSingleMode == true) {
                            var element = _this.canvas[_this.unlockedCanvasIndex];
                            element.backgroundImage ? _this.isBackgorundImage = true : _this.isBackgorundImage = false;
                            resolve();
                        }
                        else {
                            var background = [];
                            for (var i = 0; i < _this.canvas.length; i++) {
                                var element = _this.canvas[i];
                                element.backgroundImage ? background.push(true) : background.push(false);
                            }
                            _this.isBackgorundImage = _this.getFinalValue(background);
                            resolve();
                        }
                    })];
            });
    ...
    GeneratorExperimentComponent.prototype.getCanvasFill = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var finalCanvasFill, canvasFill, i, element;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                if (this.isSingleMode == true) {
    ...
    // Add Elements
    GeneratorExperimentComponent.prototype.addButton = function (props) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var promiseList;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (props.type == 'textButton')
                            ...
                            props.contentType = 6;
                        if (!(this.isSingleMode == true)) return [3 /*break*/, 1];
                        this.fabricService.addDefaultButton(this.canvas[this.unlockedCanvasIndex], props).then(function (result) {
                            _this.renderStackObjects();
                        });
                        return [3 /*break*/, 3];
                    case 1:
                        promiseList = [];
                        this.canvas.forEach(function (element) {
                            promiseList.push(_this.fabricService.addDefaultButton(element, props));
                        });
                        return [4 /*yield*/, Promise.all(promiseList).then(function (result) {
                                _this.renderStackObjects();
                            })];
                    case 2:
                        _a.sent();
    ...
    GeneratorExperimentComponent.prototype.addHeading = function (fontSize) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var props, promiseList;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!(this.isSingleMode == true)) return [3 /*break*/, 1];
                        this.fabricService.addDefaultText(this.canvas[this.unlockedCanvasIndex], props).then(function (result) {
                            _this.renderStackObjects();
                        });
                        return [3 /*break*/, 3];
                    case 1:
                        promiseList = [];
                        this.canvas.forEach(function (element) {
                            promiseList.push(_this.fabricService.addDefaultText(element, props));
                        });
                        return [4 /*yield*/, Promise.all(promiseList).then(function (result) {
                                _this.renderStackObjects();
                            })];
    ...
    GeneratorExperimentComponent.prototype.addImage = function (image) {
        var _this = this;
        return new Promise(function (resolve) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
            var props, promiseList_1;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (this.canvas[this.unlockedCanvasIndex].getObjects('image').length >= 1) {
                            ...
                            this.fabricService.addDefaultImage(this.canvas[this.unlockedCanvasIndex], props).then(function (result) {
                                _this.renderStackObjects();
                                resolve();
                            });
                        }
                    ...
                    case 1:
                        ...
                        this.canvas.forEach(function (element) {
                            if (element.getObjects('image').length >= 1) {
                                _this.showError('You are eligible for add only one image in card. You can replace It.', 6000, true);
                            }
                            else {
                                promiseList_1.push(_this.fabricService.addDefaultImage(element, props));
                            }
                        });
                        return [4 /*yield*/, Promise.all(promiseList_1).then(function (result) {
                                _this.renderStackObjects();
                                resolve();
                            })];
                    case 2:
    ...
    GeneratorExperimentComponent.prototype.addImgFromUser = function (e) {
        ...
        reader.onload = function (f) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                ...
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    ...
                    that.addImage(data).then(function (result) {
    ...
    GeneratorExperimentComponent.prototype.setProperty = function (canvasArray, objectId, property, isButtonProperty) {
        var _this = this;
        if (isButtonProperty === void 0) { isButtonProperty = false; }
        return new Promise(function (resolve, reject) {
            var promises = [];
            if (_this.isSingleMode == true && _this.unlockedCanvasIndex != null) {
                // objectId is  always null or undefined when single mode activated, so we assign it
                objectId = canvasArray[_this.unlockedCanvasIndex].getActiveObject().toJSON().id;
                var objectPromise = _this.fabricService.setPropertyToObject(canvasArray[_this.unlockedCanvasIndex], objectId, property, isButtonProperty);
                promises.push(objectPromise);
            }
            else {
                canvasArray.forEach(function (canvas, index) {
                    var objectPromise = _this.fabricService.setPropertyToObject(canvas, objectId, property, isButtonProperty);
                    promises.push(objectPromise);
                });
            }
            Promise.all(promises).then(function (result) {
    ...
    GeneratorExperimentComponent.prototype.replaceImage = function (image) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var promises;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isReplaceMode) return [3 /*break*/, 3];
                        if (!(this.isSingleMode == true)) return [3 /*break*/, 1];
                        this.replaceImageSrc(this.canvas[this.unlockedCanvasIndex], image).then(function (result) {
                            _this.renderStackObjects();
                        });
                        return [3 /*break*/, 3];
                    case 1:
                        promises = [];
                        this.canvas.forEach(function (element) {
                            var pro = _this.replaceImageSrc(element, image);
                            promises.push(pro);
                        });
    ...
    GeneratorExperimentComponent.prototype.replaceImageFromUser = function (e) {
        var file = e.target.files[0];
        var that = this;
        var reader = new FileReader();
        reader.onload = function (f) {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
                ...
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            data = f.target.result;
                            if (!(that.isSingleMode == true)) return [3 /*break*/, 1];
                            that.replaceImageSrc(that.canvas[that.unlockedCanvasIndex], data).then(function (result) {
                                that.renderStackObjects();
                            });
                            return [3 /*break*/, 3];
                        case 1:
                            promises = [];
                            that.canvas.forEach(function (element) {
    ...
    GeneratorExperimentComponent.prototype.replaceImageSrc = function (element, imageSrc) {
        var _this = this;
        return new Promise(function (resolve) {
            var object = element.getActiveObject() || element.getItemByName('id', _this.activatedLayer.id);
    ...
    GeneratorExperimentComponent.prototype.changeFontFamily = function (fontFamily, isButton) {
        var _this = this;
        if (isButton === void 0) { isButton = false; }
        this._getFontFromFamily(fontFamily).then(function (result) {
            _this.props.font = result;
            if (result != {}) {
                _this.fabricService._loadFont(_this.props.font.fontName, _this.props.font.fontSrc).then(function (result) {
                    _this.props.fontFamily = _this.props.font.fontName;
                    _this.setProperty(_this.canvas, _this.activatedLayer.id, { fontFamily: _this.props.fontFamily, fontName: _this.props.font.fontName, fontSrc: _this.props.font.fontSrc }, isButton);
                }, function (err) {
                    console.log("font Can't load", err);
                }).catch(function (err) {
                    console.log("font Can't load", err);
    ...
    GeneratorExperimentComponent.prototype._getFontFromFamily = function (family) {
        var _this = this;
        return new Promise(function (resolve) {
            var font = {};
            _this.fontList.forEach(function (element) {
    ...
    GeneratorExperimentComponent.prototype.setText = function (text, isButton) {
        if (isButton === void 0) { isButton = false; }
        this.setProperty(this.canvas, this.activatedLayer.id, { text: text }, isButton);
        this.renderStackObjects();
    };
    GeneratorExperimentComponent.prototype.setFontSize = function (fontSize, isButton) {
        if (isButton === void 0) { isButton = false; }
        // math.sign represent that numer is positive or negetive
        if (fontSize && (Math.sign(fontSize) == 1 || Math.sign(fontSize) == 0))
    ...
    GeneratorExperimentComponent.prototype.focusButtonTextArea = function () {
        var _this = this;
        if (this.isSingleMode == true) {
            var singleCanvas = this.canvas[this.unlockedCanvasIndex];
            var id = typeof singleCanvas.getActiveObject() != 'undefined' && singleCanvas.getActiveObject() != null ? singleCanvas.getActiveObject().id : this.activatedLayer.id;
            singleCanvas.getItemByName('id', id).fire('_TextEditingEnter');
        }
        else {
            this.canvas.forEach(function (element) {
                element.getItemByName('id', _this.activatedLayer.id).fire('_TextEditingEnter');
            });
        }
    };
    GeneratorExperimentComponent.prototype.blurButtonTextArea = function () {
        var _this = this;
        if (this.isSingleMode == true) {
            var singleCanvas = this.canvas[this.unlockedCanvasIndex];
            var id = typeof singleCanvas.getActiveObject() != 'undefined' && singleCanvas.getActiveObject() != null ? singleCanvas.getActiveObject().id : this.activatedLayer.id;
            ...
            this.canvas.forEach(function (element) {
                element.getItemByName('id', _this.activatedLayer.id).fire('_TextEditingExit');
            });
        }
    };
    GeneratorExperimentComponent.prototype.setButtonText = function (text, buttonEditor) {
        var _this = this;
        ...
        if (this.isSingleMode == true) {
            var singleCanvas = this.canvas[this.unlockedCanvasIndex];
            var id = typeof singleCanvas.getActiveObject() != 'undefined' && singleCanvas.getActiveObject() != null ? singleCanvas.getActiveObject().id : this.activatedLayer.id;
            var object = singleCanvas.getItemByName('id', id);
            object.fire('_TextChange');
            singleCanvas.renderAll();
        }
        else {
            this.canvas.forEach(function (element) {
                var object = element.getItemByName('id', _this.activatedLayer.id);
                object.fire('_TextChange');
                element.renderAll();
            });
        }
    ...
    GeneratorExperimentComponent.prototype.setButtonStrokeColor = function (color) {
        this.props.buttonStrokeColor = color;
        this.setProperty(this.canvas, this.activatedLayer.id, { buttonStrokeColor: color }, true);
        this.renderStackObjects();
    };
    GeneratorExperimentComponent.prototype.setButtonStrokeSize = function (size) {
        this.setProperty(this.canvas, this.activatedLayer.id, { buttonStrokeWidth: size }, true);
        this.renderStackObjects();
    };
    GeneratorExperimentComponent.prototype.setButtonFill = function (color) {
        this.props.buttonFill = color;
        this.setProperty(this.canvas, this.activatedLayer.id, { buttonFill: color }, true);
        this.renderStackObjects();
    };
    GeneratorExperimentComponent.prototype.setButtonGradient = function (colorArray) {
        var _this = this;
        ...
        if (this.isSingleMode == false) {
            this.canvas.forEach(function (canvas) {
                var obj = canvas.getItemByName('id', _this.activatedLayer.id);
                if (obj)
                    _this._setGradientToButton(canvas, JSON.parse(JSON.stringify(colorStop)), obj);
            });
        }
        else {
            var canvas = this.canvas[this.unlockedCanvasIndex];
    ...
    GeneratorExperimentComponent.prototype._setGradientToButton = function (canvas, colorStop, object) {
        // let object = canvas.getItemByName('id', this.activatedLayer.id);
        var invertangle = (this.props.buttonGradientAngle + 180) > 360 ? (this.props.buttonGradientAngle + 180) - 360 : (this.props.buttonGradientAngle + 180);
        var angle = this.props.buttonGradientAngle;
        var x1, y1, x2, y2;
        var button = { top: object.top, left: object.left, width: object.width, height: object.height };
        var p1 = this.helperService.edgeOfView(button, invertangle);
        var p2 = this.helperService.edgeOfView(button, angle);
        x1 = p1.x;
        y1 = p1.y;
    ...
    GeneratorExperimentComponent.prototype.setButtonRadius = function (radius) {
        this.setProperty(this.canvas, this.activatedLayer.id, { buttonRx: radius, buttonRy: radius }, true);
        this.renderStackObjects();
    };
    GeneratorExperimentComponent.prototype.toggleStyle = function (style, isButton) {
        if (isButton === void 0) { isButton = false; }
        switch (style) {
            case 'bold':
                this.props.isBold = !this.props.isBold;
    ...
    GeneratorExperimentComponent.prototype.toggleAlignment = function (align, isButton) {
        if (isButton === void 0) { isButton = false; }
        this.props.textAlign = align;
        this.setProperty(this.canvas, this.activatedLayer.id, { textAlign: align }, isButton);
    };
    GeneratorExperimentComponent.prototype.setOpacity = function (opacity, isButton) {
        if (isButton === void 0) { isButton = false; }
    ...
    GeneratorExperimentComponent.prototype.setSpacing = function (charSpacing, isButton) {
        if (isButton === void 0) { isButton = false; }
        this.setProperty(this.canvas, this.activatedLayer.id, { charSpacing: charSpacing }, isButton);
    };
    GeneratorExperimentComponent.prototype.setLineHeight = function (lineHeight, isButton) {
        if (isButton === void 0) { isButton = false; }
        this.setProperty(this.canvas, this.activatedLayer.id, { lineHeight: lineHeight }, isButton);
    };
    GeneratorExperimentComponent.prototype.setFill = function (fill, isButton) {
        if (isButton === void 0) { isButton = false; }
        var property = isButton == true ? { color: fill } : { fill: fill };
        this.setProperty(this.canvas, this.activatedLayer.id, property, isButton);
    };
    GeneratorExperimentComponent.prototype.setButtonIconFill = function (colorArray) {
        this.setProperty(this.canvas, this.activatedLayer.id, {
            iconColorArray: colorArray
        }, true);
    };
    GeneratorExperimentComponent.prototype.setButtonIconSize = function (buttonIconSize) {
        this.setProperty(this.canvas, this.activatedLayer.id, {
            iconSize: buttonIconSize
        }, true);
    };
    GeneratorExperimentComponent.prototype.setPreGradient = function (color) {
    ...
    GeneratorExperimentComponent.prototype.setCanvasFill = function (color) {
        var _this = this;
        if (this.isSingleMode == true) {
            this.removeBackgroundImage().then(function (result) {
                var canvas = _this.canvas[_this.unlockedCanvasIndex];
                canvas.setBackgroundColor(color, canvas.renderAll.bind(canvas));
                _this.getBackgroundType();
            });
        }
        else {
            this.removeBackgroundImage().then(function (result) {
                _this.canvas.forEach(function (element) {
    ...
    GeneratorExperimentComponent.prototype.setCanvasGradient = function (colorArray) {
        var _this = this;
        ...
        if (this.isSingleMode == false) {
            this.canvas.forEach(function (canvas) {
                _this._setGradientToCanvas(canvas, colorStop);
            });
            this.getBackgroundType();
        }
        else {
    ...
    GeneratorExperimentComponent.prototype._setGradientToCanvas = function (canvas, colorStop) {
        var invertangle = (this.props.gradientAngle + 180) > 360 ? (this.props.gradientAngle + 180) - 360 : (this.props.gradientAngle + 180);
        var angle = this.props.gradientAngle;
        var x1, y1, x2, y2;
        var c = { width: canvas.width, height: canvas.height };
        var p1 = this.helperService.edgeOfView(c, invertangle);
        var p2 = this.helperService.edgeOfView(c, angle);
        x1 = p1.x;
        y1 = p1.y;
        x2 = p2.x;
        y2 = p2.y;
    ...
    GeneratorExperimentComponent.prototype.setCanvasImage = function (image) {
        var _this = this;
        var that = this;
        // add background image
        if (that.isSingleMode == true) {
            fabric.Image.fromURL(image, function (img) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                var element;
                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                    element = that.canvas[that.unlockedCanvasIndex];
                    that.fabricService.getScaleRatio(element.width, element.height, img.width, img.height, that.props.scaleMode).then(function (result) {
                        if (result && result.scaleMode) {
                            element.setBackgroundImage(img, function () {
                                element.renderAll();
                ...
                fabric.Image.fromURL(image, function (img) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                    ...
                    return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                element = this.canvas[i];
                                return [4 /*yield*/, that.fabricService.getScaleRatio(element.width, element.height, img.width, img.height, that.props.scaleMode).then(function (result) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                        return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                            switch (_a.label) {
                                                case 0: return [4 /*yield*/, that._setBackgroundImage(result, element, img)];
                                                case 1:
                                                    _a.sent();
                                                    return [2 /*return*/];
                                            }
            ...
            for (var i = 0, length_2 = this.canvas.length; i < length_2; i++) {
                _loop_1(i, length_2);
            }
        }
    };
    GeneratorExperimentComponent.prototype._setBackgroundImage = function (result, element, img) {
        if (result && result.scaleMode) {
            element.setBackgroundImage(img, function () {
                element.renderAll();
                // this.getBackgroundType();
    ...
    GeneratorExperimentComponent.prototype.setImgAsBgFromUser = function (e) {
        var file = e.target.files[0];
        var that = this;
        var reader = new FileReader();
        reader.onload = function (f) {
    ...
    GeneratorExperimentComponent.prototype.removeBackgroundImage = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.getBackgroundType();
            if (_this.isBackgorundImage) {
                if (_this.isSingleMode == true) {
                    _this.canvas[_this.unlockedCanvasIndex].backgroundImage = null;
                    _this.canvas[_this.unlockedCanvasIndex].renderAll();
                    resolve();
                }
                else {
    ...
    GeneratorExperimentComponent.prototype.changeScaleMode = function (scaleMode) {
        var _this = this;
        var srcList = [];
        this.canvas.forEach(function (element) {
        ...
        if (finalSrc) {
            this.helperService.getMeta(finalSrc).then(function (imgdata) {
                imageHeight = imgdata.height;
                imageWidth = imgdata.width;
                _this.canvas.forEach(function (element) {
                    _this.fabricService.getScaleRatio(element.width, element.height, imageWidth, imageHeight, scaleMode).then(function (result) {
    ...
    GeneratorExperimentComponent.prototype.setBackground = function (backgroundColor, isButton) {
        if (isButton === void 0) { isButton = false; }
        var property = isButton == true ? { backgroundColor: backgroundColor } : { textBackgroundColor: backgroundColor };
        this.setProperty(this.canvas, this.activatedLayer.id, property, isButton);
    };
    GeneratorExperimentComponent.prototype.setShadow = function (shadow, isButton) {
        if (isButton === void 0) { isButton = false; }
        var property = isButton == true ? { buttonShadow: shadow } : { shadow: shadow };
        this.setProperty(this.canvas, this.activatedLayer.id, property, isButton);
    };
    GeneratorExperimentComponent.prototype.setBTextShadow = function (shadow) {
        this.setProperty(this.canvas, this.activatedLayer.id, { textShadow: shadow }, true);
    };
    GeneratorExperimentComponent.prototype.flipImage = function (value) {
        if (value == 'horizontal') {
    ...
    GeneratorExperimentComponent.prototype.changePosition = function (position) {
        this.objPosition = position;
        this.setPosition(this.objPosition);
    };
    GeneratorExperimentComponent.prototype.setPosition = function (position) {
        var _this = this;
        // position offset used for keep object little-bit far from edge of canvas
        if (this.isSingleMode == true) {
            var canvas_1 = this.canvas[this.unlockedCanvasIndex];
            var object_1 = canvas_1.getActiveObject() || canvas_1.getItemByName('id', this.activatedLayer.id);
            this._getNewPosition(position, object_1, canvas_1).then(function (result) {
                if (typeof result != "undefined") {
                    _this._setNewPosition(canvas_1, object_1, result);
                }
            });
        }
        else {
            this.canvas.forEach(function (element) {
                var object = element.getItemByName('id', _this.activatedLayer.id);
                if (object) {
                    _this._getNewPosition(position, object, element).then(function (result) {
                        if (typeof result != "undefined") {
                            if (_this.applyFor == 'all') {
                                _this._setNewPosition(element, object, result);
                            }
                            else if (_this.applyFor == 'square' && _this.fabricService.isCanvasSquare(element)) {
                                _this._setNewPosition(element, object, result);
                            }
                            else if (_this.applyFor == 'portrait' && _this.fabricService.isCanvasPortrait(element)) {
                                _this._setNewPosition(element, object, result);
                            }
                            else if (_this.applyFor == 'landscape' && _this.fabricService.isCanvasLandscape(element)) {
                                _this._setNewPosition(element, object, result);
                            }
                        }
                    });
    ...
    GeneratorExperimentComponent.prototype._getNewPosition = function (position, object, canvas) {
    ...
    GeneratorExperimentComponent.prototype._setNewPosition = function (element, object, result) {
    ...
    GeneratorExperimentComponent.prototype.backToSizes = function () {
        this.router.navigate(['/']);
    };
    // Export Canvases into JSON
    GeneratorExperimentComponent.prototype.exportJSON = function () {
        var _this = this;
        this.showLoader();
        var jsonSet = [];
        this.canvas.forEach(function (element) {
            var json = _this.generateJSON(element);
            jsonSet.push(json);
        });
        console.log('json set', JSON.stringify(jsonSet));
        this.hideLoader();
    };
    GeneratorExperimentComponent.prototype.generateJSON = function (element) {
        var json = {
            "text_json": [],
            "sticker_json": [],
            "button_json": [],
    ...
    GeneratorExperimentComponent.prototype.download = function () {
        var _this = this;
        this.showLoader();
        setTimeout(function () {
            var zip = new jszip__WEBPACK_IMPORTED_MODULE_8___default.a(), that = _this;
            _this.canvas.forEach(function (element) {
                // let w = window.open('')
    ...
    GeneratorExperimentComponent.prototype.downloadSingleCanvas = function (index) {
    ...
    GeneratorExperimentComponent.ctorParameters = function () { return [
    ...
    return GeneratorExperimentComponent;
}());
...
var HelperService = /** @class */ (function () {
    ...
    HelperService.prototype.getMeta = function (src) {
        return new Promise(function (resolve, reject) {
            var img = new Image;
    ...
    HelperService.prototype.dataURLtoBlob = function (dataurl) {
    ...
    HelperService.prototype._download = function (filename, dataUrl) {
        var element = document.createElement('a');
    ...
    HelperService.prototype._convertOffsetIntoStopColorArray = function (colorArray) {
        var cArray = [];
    ...
    HelperService.prototype._convertStopIntoOffsetColorArray = function (colorArray) {
        var cArray = [];
        colorArray.forEach(function (element) {
    ...
    HelperService.prototype.generateCssFromArray = function (colorstopArray) {
        var _this = this;
        var tmp = JSON.parse(JSON.stringify(colorstopArray));
        return new Promise(function (resolve, reject) {
            if (colorstopArray && colorstopArray.length >= 2) {
                var cssBackground_1 = 'linear-gradient(to right';
                // this.cssColorArray = [];
                _this.sortColorArray(tmp, 'stop').then(function (sortedResult) {
                    sortedResult.forEach(function (element, index) {
                        var stop = Number(element.stop);
                        var percent = _this.getPercentFromValue(stop);
                        cssBackground_1 += ', ' + element.color + ' ' + percent + '%';
                        element.stopInPercent = percent;
                    });
                    cssBackground_1 += ')';
                    resolve(cssBackground_1);
                });
            }
        });
    };
    HelperService.prototype.sortColorArray = function (arr, prop) {
        var _this = this;
        return new Promise(function (resolve) {
            arr.sort(_this.GetSortOrder(prop));
            resolve(arr);
        });
    };
    HelperService.prototype.GetSortOrder = function (prop) {
        return function (a, b) {
            if (a[prop] > b[prop]) {
                return 1;
            }
    ...
    HelperService.prototype.getPercentFromValue = function (value) {
        return ((value - 0) / (1 - 0)) * 100;
    };
    HelperService.prototype.edgeOfView = function (rect, deg) {
...
var custom_attribute = ['previewName'];
fabric.Object.prototype.toObject = (function (toObject) {
    return function (propertiesToInclude) {
...
var IconButtonGeneratorComponent = /** @class */ (function () {
    function IconButtonGeneratorComponent(fabricService, helperService) {
        this.fabricService = fabricService;
        this.helperService = helperService;
        this.isLeftShown = true;
        this.isRightShown = true;
    ...
    IconButtonGeneratorComponent.prototype.ngOnInit = function () {
        var _this = this;
        var that = this;
        ...
        for (var i = 1; i <= 228; i++) {
            ...
            this.generateProps(i, row, column, itemWidth, itemHeight, buttonMargin).then(function (props) {
                var button = new fabric.IconButton(props.source, props.property);
                _this.canvas.add(button);
                _this.canvas.renderAll();
            });
        }
    };
    IconButtonGeneratorComponent.prototype.generateProps = function (i, row, column, itemWidth, itemHeight, buttonMargin) {
        return new Promise(function (resolve) {
            resolve({
    ...
    IconButtonGeneratorComponent.prototype.openButtonBackgroundTab = function (tabName) {
        this.activeButtonBackgroundTab = tabName;
    };
    IconButtonGeneratorComponent.prototype.getAllButtonProps = function () {
        var activeObject = this.canvas.getActiveObject().toObject();
        this.props.buttonStrokeColor = activeObject.buttonStrokeColor;
        this.props.buttonStrokeWidth = activeObject.buttonStrokeWidth;
        this.props.buttonRadius = activeObject.buttonRx;
    ...
    IconButtonGeneratorComponent.prototype.setActiveColor = function (data) {
        this.props.activeGradientColor = data.colorObject.color;
        this.props.activeGradientColorIndex = data.index;
    };
    // setProeprties
    IconButtonGeneratorComponent.prototype.setButtonSize = function (prop) {
        this.setProperty(prop);
    };
    IconButtonGeneratorComponent.prototype.setOpacity = function (opacity, isButtonProperty) {
        if (isButtonProperty === void 0) { isButtonProperty = false; }
        var property = isButtonProperty == true ? { opacity: opacity } : { textOpacity: opacity };
        // this.selected.setButtonProp(property);
        this.setProperty(property);
    };
    IconButtonGeneratorComponent.prototype.setButtonStrokeColor = function (color) {
        this.props.buttonStrokeColor = color;
        // this.selected.setButtonProp({ buttonStrokeColor: color });
        this.setProperty({ buttonStrokeColor: color });
    };
    IconButtonGeneratorComponent.prototype.setButtonStrokeSize = function (size) {
        // this.selected.setButtonProp({ buttonStrokeWidth: size });
        this.setProperty({ buttonStrokeWidth: size });
    };
    IconButtonGeneratorComponent.prototype.setButtonFill = function (color) {
        this.props.buttonFill = color;
        // this.selected.setButtonProp({ buttonFill: color });
        this.setProperty({ buttonFill: color });
    };
    IconButtonGeneratorComponent.prototype.setButtonGradient = function (colorArray) {
    ...
    IconButtonGeneratorComponent.prototype._setGradientToButton = function (colorStop) {
        var invertangle = (this.props.buttonGradientAngle + 180) > 360 ? (this.props.buttonGradientAngle + 180) - 360 : (this.props.buttonGradientAngle + 180);
        var angle = this.props.buttonGradientAngle;
        var x1, y1, x2, y2, button;
    ...
    IconButtonGeneratorComponent.prototype.changeGradientIndexColor = function (index, color) {
    ...
    IconButtonGeneratorComponent.prototype.setButtonRadius = function (radius) {
        // this.selected.setButtonProp({ buttonRx: radius, buttonRy: radius });
        this.setProperty({ buttonRx: radius, buttonRy: radius });
    };
    IconButtonGeneratorComponent.prototype.setShadow = function (shadow) {
        // this.selected.setButtonProp({ buttonShadow: shadow });
        this.setProperty({ buttonShadow: shadow });
    };
    IconButtonGeneratorComponent.prototype.setButtonIconFill = function (colorArray) {
        // this.selected.setButtonProp({ iconColorArray: colorArray });
        this.setProperty({ iconColorArray: colorArray });
    };
    IconButtonGeneratorComponent.prototype.setButtonIconSize = function (buttonIconSize) {
        // this.selected.setButtonProp({ iconSize: buttonIconSize });
        this.setProperty({ iconSize: buttonIconSize });
    };
    IconButtonGeneratorComponent.prototype.setButtonIconFillForAll = function () {
        var _this = this;
        this.canvas.forEachObject(function (element) {
            if (element.type == 'iconButton') {
                // console.log(element.iconColorArray);
                var arr = element.iconColorArray;
                arr[0].color = _this.props.buttonIconColor;
    ...
    IconButtonGeneratorComponent.prototype.setProperty = function (prop) {
        if (this.selected.type == 'activeSelection') {
            this.selected._objects.forEach(function (element) {
    ...
    // Download
    IconButtonGeneratorComponent.prototype.downloadImage = function () {
        if (this.selected) {
            var width = this.selected.width * this.selected.scaleX, height = this.selected.height * this.selected.scaleY, top_1 = 0, left = 0, that_1 = this, offset = 10;
            if (that_1.selected.buttonShadow) {
                width += Math.abs(that_1.selected.buttonShadow.offsetX) + (that_1.selected.buttonShadow.blur);
    ...
    IconButtonGeneratorComponent.prototype.makeImage = function (element) {
        var _this = this;
        return new Promise(function (resolve) {
            var width = element.width * element.scaleX, height = element.height * element.scaleY, top = 0, left = 0, that = _this, offset = 10;
    ...
    IconButtonGeneratorComponent.prototype.downloadJson = function () {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var zip, selectedIconFolder, arr, selectedArr, _loop_1, this_1, obj, json, propertyToInclude, folder, jsonObject, i, length_1, mainJson, seelctedJSON;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        zip = new jszip__WEBPACK_IMPORTED_MODULE_7___default.a();
                        selectedIconFolder = zip.folder('selected Icons');
                        arr = [], selectedArr = [];
                        _loop_1 = function (i, length_1) {
                            ...
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        object = this_1.canvas.item(i);
                                        obj = {}, json = object.toJSON();
                                        propertyToInclude = "buttonFill buttonRx buttonRy buttonShadow buttonStrokeColor buttonStrokeWidth height iconColorArray iconShadow iconSize opacity scaleX scaleY stroke width".split(' ');
                                        obj['type'] = "iconButton";
                                        ...
                                        folder = zip.folder(json.previewName);
                                        jsonObject = new Blob([JSON.stringify(obj, null, 2)], { type: 'text/plain' });
                                        arr.push(obj);
                                        folder.file(json.previewName + '.txt', jsonObject);
                                        return [4 /*yield*/, this_1.makeImage(object).then(function (result) { return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](_this, void 0, void 0, function () {
                                                return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                                    switch (_a.label) {
                                                        case 0: return [4 /*yield*/, folder.file('iconButton_' + json.previewName + ".png", result.split(',')[1], { base64: true })];
                                                        case 1:
                                                            _a.sent();
                                                            if (!(this.selectedIconsIndex.indexOf(i + 1) != -1)) return [3 /*break*/, 3];
                                                            return [4 /*yield*/, selectedIconFolder.file('iconButton_' + json.previewName + ".png", result.split(',')[1], { base64: true })];
                                                        case 2:
                                                            _a.sent();
                                                            _a.label = 3;
                                                        case 3: return [2 /*return*/];
                                    ...
                                    case 1:
                                        _a.sent();
                                        if (this_1.selectedIconsIndex.indexOf(i + 1) != -1) {
                        ...
                        this_1 = this;
                        i = 0, length_1 = this.canvas.toJSON().objects.length;
                        _a.label = 1;
                    case 1:
                    ...
                    case 3:
                        ...
                        return [3 /*break*/, 1];
                    case 4:
                        mainJson = new Blob([JSON.stringify(arr, null, 2)], { type: 'text/plain' });
                        seelctedJSON = new Blob([JSON.stringify(selectedArr, null, 2)], { type: 'text/plain' });
    ...
    IconButtonGeneratorComponent.ctorParameters = function () { return [
        { type: _fabric_service__WEBPACK_IMPORTED_MODULE_2__["FabricService"] },
        { type: _helper_service__WEBPACK_IMPORTED_MODULE_3__["HelperService"] }
    ]; };
    ...
    return IconButtonGeneratorComponent;
}());
...
var CircularAngleControlComponent = /** @class */ (function () {
    function CircularAngleControlComponent(el) {
        this.el = el;
        this.degree = 0;
    ...
    CircularAngleControlComponent.prototype.ngOnInit = function () {
    };
    CircularAngleControlComponent.prototype.ngAfterViewInit = function () {
        this.initialize();
    };
    CircularAngleControlComponent.prototype.ngOnChanges = function (changes) {
        // this is because when we change array of color dynamically, we need to reflect it in this control
        this.initialize();
    };
    CircularAngleControlComponent.prototype.initialize = function () {
    ...
    CircularAngleControlComponent.prototype.getPosition = function (el) {
    ...
    CircularAngleControlComponent.prototype.onMouseDown = function ($event) {
        var newOffset = this.getPosition(this.el.nativeElement);
        this.offset = {
            left: newOffset.x,
            top: newOffset.y,
        };
    ...
    CircularAngleControlComponent.prototype.onMouseMove = function ($event) {
        if (this.mouseDown) {
    ...
    CircularAngleControlComponent.prototype.onMouseUp = function ($event) {
    ...
    CircularAngleControlComponent.prototype.rotate = function (evt) {
        evt.preventDefault();
    ...
    CircularAngleControlComponent.prototype.convertAngleToDegree = function (angle) {
        return (Math.abs(angle) * -1) + 360;
    };
    CircularAngleControlComponent.prototype.convertDegreeToAngle = function (degree) {
        return Math.abs(degree - 360);
    };
    CircularAngleControlComponent.ctorParameters = function () { return [
    ...
    return CircularAngleControlComponent;
}());
...
var GradientPickerComponent = /** @class */ (function () {
    function GradientPickerComponent() {
        ...
        this.colorArray.forEach(function (element, index) {
            element['stopInPercent'] = '0';
            element['id'] = index;
        });
        this.activeColorObject = this.colorArray[0];
    }
    GradientPickerComponent.prototype.ngAfterViewInit = function () {
    };
    GradientPickerComponent.prototype.ngOnInit = function () {
        this.initializeRamp();
    };
    GradientPickerComponent.prototype.ngOnChanges = function (changes) {
        // this is because when we change array of color dynamically, we need to reflect it in this control
        this.initializeRamp();
    };
    GradientPickerComponent.prototype.initializeRamp = function () {
        var _this = this;
        ...
        this.sortColorArray(this.colorArray, 'stop').then(function (sortedArray) {
            // this.colorArray = [];
            _this.colorArray = sortedArray;
            _this.colorArray.forEach(function (element, index) {
                var stop = Number(element.stop);
                var percent = _this.getPercentFromValue(stop);
                element.stopInPercent = percent;
                element.id = index;
            });
            _this.generateCssFromArray(_this.colorArray).then(function (result) {
                _this.cssBackground = result;
                _this.activeColorObject = _this.colorArray[0];
            });
        });
    };
    GradientPickerComponent.prototype.getValuefromPercent = function (percent) {
        return Number(((percent * (this.maxColorStop - this.minColorStop) / 100) + this.minColorStop).toFixed(2));
    };
    GradientPickerComponent.prototype.getPercentFromValue = function (value) {
        return ((value - this.minColorStop) / (this.maxColorStop - this.minColorStop)) * 100;
    };
    GradientPickerComponent.prototype.generateCssFromArray = function (colorstopArray) {
        var _this = this;
        var tmp = JSON.parse(JSON.stringify(colorstopArray));
        return new Promise(function (resolve, reject) {
            if (colorstopArray && colorstopArray.length >= 2) {
                var cssBackground_1 = 'linear-gradient(to right';
                if (typeof _this.minColorStop != "undefined" && typeof _this.maxColorStop != "undefined") {
                    // this.cssColorArray = [];
                    _this.sortColorArray(tmp, 'stop').then(function (sortedResult) {
                        sortedResult.forEach(function (element, index) {
                            var stop = Number(element.stop);
    ...
    GradientPickerComponent.prototype.addColor = function (event, color) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var newPercent, stop, _loop_1, this_1, out_index_1, index, arrLength;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        newPercent = Number((event.offsetX * 100 / event.target.offsetWidth).toFixed(2));
                        stop = this.getValuefromPercent(newPercent);
                        if (!(newPercent <= this.colorArray[0].stopInPercent)) return [3 /*break*/, 1];
                        ...
                        this.generateCssFromArray(this.colorArray).then(function (result) {
                            _this.cssBackground = result;
                            _this.activeColorObject = _this.colorArray[0];
                            _this.refreshAllId();
                            _this.onPickerChange.emit(_this.colorArray);
                            _this.onColorAdd.emit(_this.colorArray);
                        });
                        return [2 /*return*/];
                    case 1:
                        if (!(newPercent >= this.colorArray[this.colorArray.length - 1].stopInPercent)) return [3 /*break*/, 2];
                        ...
                        this.generateCssFromArray(this.colorArray).then(function (result) {
                            _this.cssBackground = result;
                            _this.activeColorObject = _this.colorArray[_this.colorArray.length - 1];
                            _this.refreshAllId();
                            _this.onPickerChange.emit(_this.colorArray);
                            _this.onColorAdd.emit(_this.colorArray);
                        });
                        return [2 /*return*/];
                    case 2:
                        _loop_1 = function (index, arrLength) {
                            var element;
                            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        element = this_1.colorArray[index];
                                        if (!(element.stopInPercent <= newPercent)) return [3 /*break*/, 1];
                                        return [3 /*break*/, 3];
                                    case 1:
                                        this_1.colorArray.splice(index, 0, {
                                            color: color,
                                            stop: stop,
                                            stopInPercent: newPercent
                                        });
                                        return [4 /*yield*/, this_1.generateCssFromArray(this_1.colorArray).then(function (result) {
                                                _this.cssBackground = result;
                                                _this.activeColorObject = _this.colorArray[index];
                                                _this.refreshAllId();
                                                _this.onPickerChange.emit(_this.colorArray);
                                                _this.onColorAdd.emit(_this.colorArray);
                        ...
                        this_1 = this;
                        index = 0, arrLength = this.colorArray.length;
                        _a.label = 3;
                    case 3:
                        if (!(index < arrLength)) return [3 /*break*/, 6];
                        return [5 /*yield**/, _loop_1(index, arrLength)];
                    case 4:
                        _a.sent();
                        index = out_index_1;
                        _a.label = 5;
    ...
    GradientPickerComponent.prototype.touchStart = function (e, colorElement, index) {
        ...
        var offsetLeft = e.target.offsetLeft - 5 + Math.sqrt(200) / 2;
        var offsetTop = e.target.offsetTop - 5 + Math.sqrt(200) / 2;
    ...
    GradientPickerComponent.prototype.dragAction = function (e) {
        var _this = this;
        if (this._dragControl) {
            ...
            var pixel = (this._oldPosition - this._posX2);
            this._oldPosition = pixel;
            var pixelVertrical = (this._oldPositionVertical - this._posY2);
            ...
            if (this._oldPosition >= 0 && this._oldPosition <= this.addArea.nativeElement.offsetWidth) {
                var newPercent = Number((this._oldPosition * 100 / this.addArea.nativeElement.offsetWidth).toFixed(2));
                var stop_1 = this.getValuefromPercent(newPercent);
                this._activeItem.style.left = newPercent + "%";
                this.colorArray[this._activeDragControl].stop = stop_1;
                this.colorArray[this._activeDragControl].stopInPercent = newPercent;
                this.generateCssFromArray(this.colorArray).then(function (result) {
                    _this.cssBackground = result;
                    _this.onColorSliding.emit(_this.colorArray);
                });
            }
        }
    };
    GradientPickerComponent.prototype.dragEnd = function () {
        var _this = this;
        this.removeArea.nativeElement.style.backgroundColor = 'transparent';
        document.onmouseup = null;
        ...
        if (this._oldPositionVertical <= 10) {
            if (this.colorArray.length > this.minimumColors) {
                var index = this.colorArray.findIndex(function (color) { return color.id == _this.activeColorObject.id; });
                this.colorArray.splice(index, 1);
                this.generateCssFromArray(this.colorArray).then(function (result) {
                    _this.cssBackground = result;
                    _this.refreshAllId();
                    _this.onPickerChange.emit(_this.colorArray);
                    _this.onColorRemove.emit(_this.colorArray);
                });
            }
        }
        else {
            this.sortColorArray(this.colorArray, 'stop').then(function (result) {
                _this.colorArray = result;
                _this.onPickerChange.emit(_this.colorArray);
                _this.onColorSlideEnd.emit(_this.colorArray);
                var index = _this.colorArray.findIndex(function (color) { return color.id == _this.activeColorObject.id; });
                _this.onColorControlActivate.emit({ index: index, colorObject: _this.activeColorObject });
            });
        }
    };
    GradientPickerComponent.prototype.openColorPicker = function (id) {
        document.getElementById(id).click();
    };
    GradientPickerComponent.prototype.sortColorArray = function (arr, prop) {
        var _this = this;
        return new Promise(function (resolve) {
            arr.sort(_this.GetSortOrder(prop));
            resolve(arr);
    ...
    GradientPickerComponent.prototype.GetSortOrder = function (prop) {
        return function (a, b) {
            if (a[prop] > b[prop]) {
                return 1;
            }
    ...
    GradientPickerComponent.prototype.changeColor = function (color, i) {
        var _this = this;
        this.generateCssFromArray(this.colorArray).then(function (result) {
            _this.cssBackground = result;
            _this.onPickerChange.emit(_this.colorArray);
    ...
    GradientPickerComponent.prototype.refreshAllId = function () {
        this.colorArray.forEach(function (element, index) {
            element['id'] = index;
        });
    };
...
var LabledIconButtonComponent = /** @class */ (function () {
    function LabledIconButtonComponent() {
        this.lable = "Button";
    ...
    LabledIconButtonComponent.prototype.ngOnInit = function () {
    };
    LabledIconButtonComponent.prototype.onButtonClick = function () {
        this.onClick.emit();
    };
    tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])(),
    ...
    return LabledIconButtonComponent;
}());
...
var PropertySliderComponent = /** @class */ (function () {
    function PropertySliderComponent() {
        this.lable = "Lable";
        this.min = 0;
        this.max = 1;
        this.step = 0.1;
    ...
    PropertySliderComponent.prototype.ngOnInit = function () {
    };
    PropertySliderComponent.prototype.change = function ($event) {
        var _this = this;
